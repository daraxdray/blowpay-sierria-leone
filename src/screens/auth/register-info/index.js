...
useEffect(() => {
  ...
  return (
    <ScreenView style={[styles.container,  { marginBottom: keyboardHeight }]} light color={WHITE}>
          <KeyboardAvoidingView >
                ...
                <View style={styles.v21}>
                  <View style={styles.rowView}>
                    ...
                    /><Text style={styles.text13}>
                      ...
                      <Text style={[styles.underlineText,]} onPress={()=>Linking.openURL(`https://${Platform.OS === 'ios' || AppConstant.isAmazonStore ? 'BlowPay.app/terms-and-conditions' : 'https://billsbyblowmoney.com/terms.html'}`)} >
                       Terms of Service
                      </Text>
                      {' '}and{' \n'}
                      <Text style={styles.underlineText} onPress={()=>Linking.openURL(`https://${Platform.OS === 'ios'  || AppConstant.isAmazonStore ? 'BlowPay.app/policy' : 'https://billsbyblowmoney.com/terms.html'}`)} > Privacy Policy</Text>
                      
                    </Text>
                  </View>

                  <View style={[styles.rowView, {marginLeft: -10}]}>
                    <Checkbox
                    ...
                    <Text style={styles.checkboxText}>
                      Send me updates and newsletter about {Platform.OS === 'ios' || AppConstant.isAmazonStore ? 'BlowPay' : 'BillsByBlowmoney'} products &
                      services
                    </Text>
                  </View>
